 ...
 */
#define set_mkd2_flag(flags, item) ((flags)->bit[item] = 1)
#define clear_mkd2_flag(flags, item) ((flags)->bit[item] = 0)
...
convert_v2flags(mkd2_flag_t* v2flags, mkd3_flag_t *v3flags)
{
    ...
    set_mkd2_flag(v3flags, MKD_DLDISCOUNT);	/* default for discount dls changed from on to off in v3 */
	...
	switch ( bitmask & bit ) {
	case MKD2_STRICT:	set_mkd2_flag(v3flags,MKD_STRICT);
				break;
	case MKD2_NOLINKS:	set_mkd2_flag(v3flags,MKD_NOLINKS);
				break;
	case MKD2_NOIMAGE:	set_mkd2_flag(v3flags,MKD_NOIMAGE);
				break;
	case MKD2_NOPANTS:	set_mkd2_flag(v3flags,MKD_NOPANTS);
				break;
	case MKD2_NOHTML:	set_mkd2_flag(v3flags,MKD_NOHTML);
				break;
	case MKD2_TAGTEXT:	set_mkd2_flag(v3flags,MKD_TAGTEXT);
				break;
	case MKD2_NO_EXT:	set_mkd2_flag(v3flags,MKD_NO_EXT);
				break;
	case MKD2_CDATA:	set_mkd2_flag(v3flags,MKD_CDATA);
				break;
	case MKD2_NOSUPERSCRIPT:set_mkd2_flag(v3flags,MKD_NOSUPERSCRIPT);
				break;
	case MKD2_STRICT2:	set_mkd2_flag(v3flags,MKD_STRICT);
				break;
	case MKD2_NOTABLES:	set_mkd2_flag(v3flags,MKD_NOTABLES);
				break;
	case MKD2_NOSTRIKETHROUGH: set_mkd2_flag(v3flags,MKD_NOSTRIKETHROUGH);
				break;
	case MKD2_TOC:		set_mkd2_flag(v3flags,MKD_TOC);
				break;
	case MKD2_1_COMPAT:	set_mkd2_flag(v3flags,MKD_1_COMPAT);
				break;
	case MKD2_AUTOLINK:	set_mkd2_flag(v3flags,MKD_AUTOLINK);
				break;
	case MKD2_SAFELINK:	set_mkd2_flag(v3flags,MKD_SAFELINK);
				break;
	case MKD2_NOHEADER:	set_mkd2_flag(v3flags,MKD_NOHEADER);
				break;
	case MKD2_TABSTOP:	set_mkd2_flag(v3flags,MKD_TABSTOP);
				break;
	case MKD2_NODIVQUOTE:	set_mkd2_flag(v3flags,MKD_NODIVQUOTE);
				break;
	case MKD2_NOALPHALIST:	set_mkd2_flag(v3flags,MKD_NOALPHALIST);
				break;
	case MKD2_EXTRA_FOOTNOTE: set_mkd2_flag(v3flags,MKD_EXTRA_FOOTNOTE);
				break;
	case MKD2_NOSTYLE:	set_mkd2_flag(v3flags,MKD_NOSTYLE);
				break;
	case MKD2_NODLDISCOUNT:	clear_mkd2_flag(v3flags,MKD_DLDISCOUNT);
				break;
	case MKD2_DLEXTRA:	set_mkd2_flag(v3flags,MKD_DLEXTRA);
				break;
	case MKD2_FENCEDCODE:	set_mkd2_flag(v3flags,MKD_FENCEDCODE);
				break;
	case MKD2_IDANCHOR:	set_mkd2_flag(v3flags,MKD_IDANCHOR);
				break;
	case MKD2_GITHUBTAGS:	set_mkd2_flag(v3flags,MKD_GITHUBTAGS);
				break;
	case MKD2_URLENCODEDANCHOR: set_mkd2_flag(v3flags,MKD_URLENCODEDANCHOR);
				break;
	case MKD2_LATEX:	set_mkd2_flag(v3flags,MKD_LATEX);
				break;
	case MKD2_EXPLICITLIST:	set_mkd2_flag(v3flags,MKD_EXPLICITLIST);
				break;
	}
    }
}
